  ...
  return (
    <section className="relative min-h-screen w-full flex items-center overflow-hidden pt-24 md:pt-16">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 md:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center relative z-10 py-12">
        ...
        >
          ...
          >
            ...
            <div className="relative z-10 flex items-center gap-3 w-full text-white select-none">
              <Sparkles size={13} className="text-[#C5A059] shrink-0 animate-pulse" />
        ...
        >
          <div className="absolute -inset-4 z-0 pointer-events-none filter blur-3xl opacity-30 mix-blend-multiply bg-radial from-[#C5A059] via-neutral-950 to-transparent rounded-full" />
