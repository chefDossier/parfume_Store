        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-x-6 gap-y-12 items-start">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-2 text-xs font-light">
              <li><a href="#parfums" className="text-neutral-600 hover:text-[#C5A059] transition-colors duration-300">Parfums d'Exception</a></li>
              <li><a href="#brumes" className="text-neutral-600 hover:text-[#C5A059] transition-colors duration-300">Brumes &amp; Mists</a></li>
              <li><a href="#coffrets" className="text-neutral-600 hover:text-[#C5A059] transition-colors duration-300">Coffrets Cadeaux</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-2 space-y-4">
            ...
            <ul className="space-y-2 text-xs font-light">
              <li><a href="#diagnostic" className="text-neutral-600 hover:text-[#C5A059] transition-colors duration-300">Diagnostic Privé</a></li>
              <li><a href="#discover" className="text-neutral-600 hover:text-[#C5A059] transition-colors duration-300">Nos Marques</a></li>
              <li><a href="#contact" className="text-neutral-600 hover:text-[#C5A059] transition-colors duration-300">Prendre RDV</a></li>
            </ul>
          </div>
